...
class SecondExperimentScene: SKScene {
    ...
    func setupScene() {
        ...
        for i in 0..<9 {
            addLabelNode(withText: "_", fontSize: 90, position: CGPoint(x: positions[i], y: 265), name: "letterSlot\(i)")
        ...
        addLabelNode(withText: ExperimentStrings.secondResponse, fontSize: 120, position: CGPoint(x: 500, y: 480), name: "responseString")
